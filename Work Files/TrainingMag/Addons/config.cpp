...
class CfgPatches
{
	...
	{
		units[]				= {};
		weapons[]			= {"JMSST_mk1Rifle","JMSST_mk1CRifle","JMSST_mk1dmrRifle","JMSST_mk4Rifle"}; // classname from below in cfgWeapons
		magazines[]			= {"ZDN_75rnd_762x51_MoritaMag_Training", "ZDN_75rnd_762x51_MoritaMag_Rubber","ZDN_75rnd_762x51_MoritaMag_Live","ZDN_30rnd_762x51_MoritaMag_Live_AP","ZDN_75rnd_9mmCaseless_MoritaMag_Live"}; // new classnames down below from cfgMagazines
		requiredVersion		= 0.1;
...
class CfgMagazines
{
	...
	class ZDN_75rnd_9mmCaseless_MoritaMag_Live: JMSST_75Rnd_762x51_MoritaMag
	{
		scope				= 2;
		author				= "DragonGurdian5";
		displayname			= "75rnd 9mm Caseless (Live)";
		ammo = "ZDN_9mm_Caseless_Ammo";
		count = "75"; // change to the amount of bullets you want mag to have
	};
};
...
class cfgWeapons
{
	...
	class JMSST_mk4Rifle: JMSST_Rifle_Base_F_Base
	{
		scope = 2;
		magazines[] = {
			"ZDN_75rnd_9mmCaseless_MoritaMag_Live"
		};
	};
};
